...
Route::middleware('auth')->group(function () {
    ...
    Route::get('todo-list/{id}/delete', [TodoListController::class, 'delete'])->name('todo-list.delete');
});

Route::middleware('auth')->group(function () {
    Route::get('/tasks/create/{userId}', [TaskController::class, 'create'])->name('tasks.create');
